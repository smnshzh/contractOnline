...
if selected_option == "Option 1" :
    ...
    if file:
        ...
        if selected_person:
            ...
            month_seniority = int(monthly_base_salary)*30/12
                        # Path to the HTML file
            contract_list = os.listdir('./contracts')
            select_contract = st.selectbox(label="نوع قرارداد را انتخاب نمایید",options=contra)
            html_file_path = './contract2.html'
    ...
    'daily_base_salary': daily_base_salary,
    ...
    'month_seniority':"{:,.0f}".format(float(month_seniority)),
    'eydi':"{:,.0f}".format(float(month_seniority*2))
}
